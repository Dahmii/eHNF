...
<div id="bookLaunchModal" class="modal">
    <div class="modal-content">
        ...
        <!-- Order Now Button -->
        <button class="btn btn-secondary btn-hover-primary" style="margin-top: 30px;" onclick="window.location.href='https://paystack.shop/meal-planner'">Preorder Now!</button>
    </div>
</div>
